...
export default function Card({ title, details }) {
    ...
    function addFavorite(uid, typeDetail, item) {
        console.log(favoritesList.filter((element) => element.item !== item ));
    ...
    return (
        <div className="card" style={{ minWidth: "18rem" }}>
            <img src="https://via.placeholder.com/400x200" className="card-img-top" alt={details.properties.name} />
            <div className="card-body">
                ...
                <div className="d-flex justify-content-between">
                    <Link to={`/${url_details}/${details.uid}`}>
